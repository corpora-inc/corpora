...
export const GenerateDraftDialog: React.FC<GenerateDraftDialogProps> = ({
    open,
    onClose,
}) => {
    ...
    const { configs, defaultProvider, availableModels } =
        useLLMConfigStore()

    // pick initial provider/model
    ...
    const [provider, setProvider] =
        useState<ProviderType>(initProvider)
